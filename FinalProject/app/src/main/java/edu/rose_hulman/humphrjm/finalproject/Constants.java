...
public class Constants {
    ...
    public static StorageReference DB_STORAGE_ROOT = FirebaseStorage.getInstance().getReferenceFromUrl("gs://digital-boating-tool.appspot.com").child(MainActivity.ANDROID_ID);
